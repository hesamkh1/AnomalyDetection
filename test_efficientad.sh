...
/home/zf/Thesis/AnomalyDetection/venv/bin/python3.12  mvtec_ad_evaluation/evaluate_experiment.py \
    ...
    --anomaly_maps_dir './output/plastic_nut_mini_imagenet_full_penalty0.75/anomaly_maps/mvtec_ad/' \
    --output_dir './output/plastic_nut_mini_imagenet_full_penalty0.75/metrics/mvtec_ad/' \
